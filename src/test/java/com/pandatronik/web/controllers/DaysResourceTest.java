...
//
//        DaysEntity day = DaysEntity.builder().id(1L).body("Some Day").rateDay(MadeEnum.HUNDRED).build();
//
...
//        UserEntity user = UserEntity.builder().build();
//        DaysEntity day = DaysEntity.builder().id(1L).body("Some Day")
