...
@PropertySource("file:///${user.home}/.pandatronik_properties/application-common.properties")
@PropertySource("file:///${user.home}/.pandatronik_properties/stripe.properties")
