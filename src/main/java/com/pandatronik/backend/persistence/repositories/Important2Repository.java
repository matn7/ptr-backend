...
@Repository
public interface Important2Repository extends CrudRepository<Important2Entity, Long>, EntityRepository<Important2Entity> {
    ...
    @Query("SELECT i FROM Important2Entity i WHERE i.userId = :userId")
    Optional<List<Important2Entity>> findByUserId(@Param("userId") UserEntity userEntity);
