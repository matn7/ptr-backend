...
public interface Important2Repository extends CrudRepository<Important2Entity, Long> {
    ...
    Optional<Important2Entity> findById(@Param("userId") long userId, @Param("id") Long id);
    ...
    Optional<Important2Entity> findByDate(@Param("userId") long userId, @Param("day") int day,
                                          @Param("month") int month, @Param("year") int year);

    @Query("SELECT i FROM Important2Entity i WHERE " +
            "MONTH(i.startDate) = :month AND YEAR(i.startDate) = :year AND i.userId = :userId")
    List<Important2Entity> findByDate(@Param("userId") long userId,
