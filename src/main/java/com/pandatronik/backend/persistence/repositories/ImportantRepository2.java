...
public interface ImportantRepository2 extends CrudRepository<ImportantEntity2, Long> {
    ...
    Optional<ImportantEntity2> getImportantByUidId(@Param("userProfileId") String userProfileId, @Param("id") Long id);
    ...
    Optional<ImportantEntity2> getImportantByUidDayMonthYeat(@Param("userProfileId") String userProfileId, @Param("day") int day,
    ...
    Optional<ImportantEntity2> updateImportantByUidId(@Param("title") String title, @Param("body") String body, @Param("made") int made,
