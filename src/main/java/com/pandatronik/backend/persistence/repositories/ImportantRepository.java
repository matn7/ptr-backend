...
public interface ImportantRepository extends CrudRepository<ImportantEntity, Long> {
    ...
    Optional<ImportantEntity> getImportantByUidId(@Param("name") String userProfileId, @Param("id") Long id);
    ...
    Optional<ImportantEntity> getImportantByUidDayMonthYeat(@Param("name") String userProfileId, @Param("day") int day,
    ...
    Optional<ImportantEntity> updateImportantByUidId(@Param("title") String title, @Param("body") String body, @Param("made") int made,
