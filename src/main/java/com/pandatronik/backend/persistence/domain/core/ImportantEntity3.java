...
public class ImportantEntity3 implements Serializable {
    ...
    public static ImportantEntity3 newImportantRecord(String userProfileId, ImportantEntity3 importantEntity) {
        return new ImportantEntity3(importantEntity.getTitle(), importantEntity.getBody(), importantEntity.getMade(),
