...
import com.pandatronik.exceptions.S3Exception;
...
//	private AmazonS3Client s3Client;
	...
	public String storeProfileImage(MultipartFile uploadedFile, String username) {
		Preconditions.checkNotNull(uploadedFile, "uploadedFile must not be null");
		...
		try {
			if (uploadedFile != null && !uploadedFile.isEmpty()) {
				...
				// The root of our temporary assets. Will create if it doesn't
				// exist
